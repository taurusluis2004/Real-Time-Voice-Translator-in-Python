...
def destination_language():
    print("Enter a sentence  the language in which you	want to convert : Ex. Hindi , English , Spanish, etc.")
    print()
...
languages_chosen=["english","spanish"]
